...
function reducer(state, { type, payload }) {
  switch (type) {
    ...
    case ACTION.EVALUATE :
      ...
      return {
        ...state,
        overwrite: true, //this is because after final result we can not add new digit, like if final answer is 5, we shouldn't be allowed to write any other letter and manupulate the result
...
function formatOperand(operand){ // this part is for putting comma if the number is big
